        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
              <p>
My journey into web development started with a curiosity about how websites work. Over time, this curiosity grew into a passion for building and experimenting with ideas on the web. </p>
              <p>
I enjoy learning both the technical and creative sides of development, understanding how design and engineering work together. My approach is simple make it work first, then improve the experience.              </p>
              <p>
When I’m not coding, I like exploring creative interests and learning new things that keep me inspired and motivated.              </p>
            </div>
          ...
          >
            <div className="relative aspect-[4/5] w-full max-w-md mx-auto">
              <div className="absolute inset-0 bg-[#ffc2c7] rounded-3xl transform rotate-6 scale-95 opacity-50 translate-x-4 translate-y-4" />
              <div className="absolute inset-0 bg-[#b6e5d8] rounded-3xl transform -rotate-3 scale-95 opacity-50 -translate-x-2 -translate-y-2" />
              ...
              <div className="relative h-full w-full bg-slate-200 dark:bg-slate-800 rounded-3xl overflow-hidden shadow-2xl border-4 border-white dark:border-slate-900">
                ...
                {/* man in glasses looking at computer screen */}
                <img 
                  src="mine.png" 
                  alt="Portrait"
